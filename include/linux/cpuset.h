...
extern void cpuset_cgroup_cpus_allowed(struct cgroup *cgroup, struct cpumask *mask);
extern void cpuset_cgroup_cpus_effective(struct cgroup *cgroup, struct cpumask *mask);
